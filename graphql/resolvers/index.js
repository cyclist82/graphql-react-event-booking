...
const singleEvenet = async eventId => {
    try {
            ...
            return events
                .map(event => {
                    return {
                        ...
                        // user user function to populate the creator field with data from the database
            ...
            return bookings
                .map(booking => {
                    return {
                        ...
                        event: singleEvenet.bind(this, booking._doc.event),
